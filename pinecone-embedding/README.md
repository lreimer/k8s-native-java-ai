...
You can then execute your native executable with: `./build/pinecone-embedding-1.0.0-SNAPSHOT-runner`
...
- LangChain4j Pinecone embedding store ([guide](https://docs.quarkiverse.io/quarkus-langchain4j/dev/index.html)): Provides the Pinecone Embedding store for LangChain4j
